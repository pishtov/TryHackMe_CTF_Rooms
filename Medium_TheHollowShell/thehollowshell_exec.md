...
The room ultimately demonstrates why archive extraction must carefully prevent path traversal and why background workers that automatically execute uploaded content can turn a file-write vulnerability into full remote 
code execution.
